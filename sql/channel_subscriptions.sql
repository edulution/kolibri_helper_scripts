...
FOR classRow IN (SELECT *FROM kolibriauth_collection WHERE kind = 'classroom') LOOP 
	...
	IF classRow.name LIKE 'Grade 7%' THEN
		UPDATE kolibriauth_collections
		...
		SET subscriptions = '"[\"f3f6bf4b9c424b6fbd90bece1418a415\",\"3a126f041a9e4127978bb6544a099d0d\",\"03761fe9a2424e9ebd367fbae14dc134\",\"f12e2f67d5894b34bb942484d880c4a6\",\"8d368058656544e2b7fe62eb2a632698\"]"'
		WHERE name = 'Level 1'
