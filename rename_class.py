...
argParser.add_argument('--new_name', '-n', help='New name of the class you with to rename')
...
if __name__ == '__main__':
    ...
    if args.old_name and args.new_name:
        ...
        sys.exit('Please supply the old name and new name of the class with the appropriate arguments')
