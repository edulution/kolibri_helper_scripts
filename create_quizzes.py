...
import uuid
import random
from helpers import get_facility_or_default, get_or_create_classroom, get_or_create_learnergroup, get_channels_in_module, get_admins_for_facility
django.setup()
    ...
    for channel_id in channel_ids:
        ...
        for topic_id in topic_ids:
            ...
            if len(quiz_content) == 0:
                print "Could not cerate quiz {}. Not enough content".format(str(quiz_title))
