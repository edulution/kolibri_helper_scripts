...
def update_learner_details(input_file):
            ...
            for user in users:
                ...
                try:
                    ...
                    if (user_object.full_name == user["full_name"]) and (user_object.username == user["username"]):
                        ...
                        user_object.save()
                        # Print success message and update success count if user details were successfully updated
                        success_count += 1
                        ...
                        cursor = conn.cursor()
                        # Update username in responses table where user_id matches the user_id from the input file and commit changes
                ...
                # Print error message and update not_exist_count if user does not exist
    ...
    # Print error message if input file does not exist
